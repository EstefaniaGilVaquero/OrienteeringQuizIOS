...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func configuracionNavigationBar(){
        ...
        shadow.shadowOffset = CGSize(width: 0.0, height: 1.5)
        
        navigationBarAppearance.titleTextAttributes = [NSForegroundColorAttributeName: UIColor.white, NSShadowAttributeName: shadow]
